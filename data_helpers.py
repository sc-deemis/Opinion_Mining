...
def read_data(file=None):
    ...
    col_names = [ 'Message','System-Id', 'WM1', 'WM2','distance', 'drug-offset-end','drug-offset-start',
                   'relType','sideEffect-offset-end','sideEffect-offset-start']
    # col_names = ['Message', 'Drug_Regimen', 'drug-offset-start', 'drug-offset-end', 'Phrase',
    #              'sideEffect-offset-start',
    #              'sideEffect-offset-end', 'relType']
